...
#if DECODERS_ONLY
 #define FFMPEG_VERSION         "0.4.9-pre1 dec"
#else
...
#define FF_DCT_INT     2
#define FF_DCT_MMX     3
#define FF_DCT_FAAN    4
#define FF_DCT_MLIB    5
#define FF_DCT_ALTIVEC 6
...
/* memory */
typedef void* (*av_malloc_fc)(unsigned int size);
extern av_malloc_fc av_malloc;
void *av_mallocz(unsigned int size);
typedef void* (*av_realloc_fc)(void *ptr, unsigned int size);
extern av_realloc_fc av_realloc;
typedef void (*av_free_fc)(void *ptr);
extern av_free_fc av_free;
