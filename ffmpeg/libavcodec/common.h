...
#ifndef INT64_MIN
#define INT64_MIN       (-int64_t_C(0x7fffffffffffffff)-1)
#endif
...
#if (defined(ARCH_X86) || defined(ARCH_X86_64)) && 0
...
// under stlport 4.0 next line is resulted in compilation error, so simply comment it out because time() isn't 
// uses in this module
