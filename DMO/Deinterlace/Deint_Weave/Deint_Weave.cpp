////////////////////////////////////////////////////////////////////////////
// $Id: Deint_Weave.cpp,v 1.1 2003-05-21 13:41:12 adcockj Exp $
/////////////////////////////////////////////////////////////////////////////
    ...
    if(InputInfo->bmiHeader.biCompression == MAKEFOURCC('Y','U','Y','2'))
    {
        if(InputInfo->bmiHeader.biWidth != 704)
        {
            if(m_IncomingFields[m_FieldsInBuffer - 1].IsTopLine == TRUE)
            {
                ...
                {
                    memcpy(pOutputData, pInputDataNewer, InputInfo->bmiHeader.biWidth * 2);
                    pOutputData += OutputInfo->bmiHeader.biWidth * 2;
                    memcpy(pOutputData, pInputDataOlder, InputInfo->bmiHeader.biWidth * 2);
                    pOutputData += OutputInfo->bmiHeader.biWidth * 2;
    ...
    else
    {
        if(InputInfo->bmiHeader.biWidth != 704)
        {
            ...
            if(m_IncomingFields[m_FieldsInBuffer - 1].IsTopLine == TRUE)
            {
                ...
                for(int i(0); i < InputInfo->bmiHeader.biHeight/2; ++i)
                {
                    memcpy(pOutputData, pInputDataNewer, InputInfo->bmiHeader.biWidth);
                    pOutputData += OutputInfo->bmiHeader.biWidth;
                    memcpy(pOutputData, pInputDataOlder, InputInfo->bmiHeader.biWidth);
                    pOutputData += OutputInfo->bmiHeader.biWidth;
                    pInputDataNewer += InputInfo->bmiHeader.biWidth * 2;
                    pInputDataOlder += InputInfo->bmiHeader.biWidth * 2;
                }
        ...
        else
        {
            ...
            pOutputData -= 8;
            ProcessPlanarChroma704(pInputDataNewer, pOutputData, InputInfo, OutputInfo);
        }
    }
}
