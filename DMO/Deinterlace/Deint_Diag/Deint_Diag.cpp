////////////////////////////////////////////////////////////////////////////
// $Id: Deint_Diag.cpp,v 1.14 2004-12-06 18:04:54 adcockj Exp $
/////////////////////////////////////////////////////////////////////////////
...
extern "C"
{
    ...
    void __cdecl Deint_Diag_Core_Chroma_MMX(BYTE* M1, BYTE* T2, BYTE* B2, BYTE* MapTop, BYTE* MapMiddle, BYTE* MapBottom, BYTE* Dest, DWORD Count);
    void __cdecl Deint_Diag_Core_Chroma_SSE(BYTE* M1, BYTE* T2, BYTE* B2, BYTE* MapTop, BYTE* MapMiddle, BYTE* MapBottom, BYTE* Dest, DWORD Count);
    void __cdecl Deint_Diag_Core_Chroma_3DNOW(BYTE* M1, BYTE* T2, BYTE* B2, BYTE* MapTop, BYTE* MapMiddle, BYTE* MapBottom, BYTE* Dest, DWORD Count);
...
#define DIAG_YUY2 0
#define DIAG_LUMA 1
#define DIAG_CHROMA 2

DIAG_FUNC* DiagFunctions[3][3] = 
{
	{Deint_Diag_Core_YUY2_MMX, Deint_Diag_Core_Luma_MMX, Deint_Diag_Core_Chroma_MMX,},
	{Deint_Diag_Core_YUY2_3DNOW, Deint_Diag_Core_Luma_3DNOW, Deint_Diag_Core_Chroma_3DNOW,},
	{Deint_Diag_Core_YUY2_SSE, Deint_Diag_Core_Luma_SSE, Deint_Diag_Core_Chroma_SSE,},
};
...
void CDeint_Diag::ProcessChromaTop(BYTE* pUpperChroma, BYTE* pLowerChroma, BYTE* pMapData, BYTE* pOutputData, VIDEOINFOHEADER2* InputInfo, VIDEOINFOHEADER2* OutputInfo)
{
    ...
    for(i = 0; i < InputInfo->bmiHeader.biHeight/4 - 1; ++i)
    {
        ...
        DiagFunctions[FunctionIndex][DIAG_CHROMA](
													pLowerChroma,
													pUpperChroma,
