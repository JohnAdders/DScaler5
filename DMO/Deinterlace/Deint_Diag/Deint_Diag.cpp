////////////////////////////////////////////////////////////////////////////
// $Id: Deint_Diag.cpp,v 1.10 2003-10-31 17:19:37 adcockj Exp $
/////////////////////////////////////////////////////////////////////////////
...
STDMETHODIMP CDeint_Diag::Process(IInterlacedBufferStack* Stack, IMediaBuffer* pOutputBuffer)
{
    ...
    CComPtr<IInterlacedField> pFields[NUM_FIELDS];
    ...
    {
        HRESULT hr = Stack->GetField(i, &pFields[i]); 
...
BOOL WINAPI DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID /*lpReserved*/)
{
	if (DLL_PROCESS_ATTACH == dwReason)
	{
		...
		{
			MessageBox(NULL, "Must be at least an MMX processor", "Deint_Diag.dll", MB_ICONEXCLAMATION);
		}
	}
