////////////////////////////////////////////////////////////////////////////
// $Id: CDeintDMO.cpp,v 1.15 2004-12-06 18:04:48 adcockj Exp $
/////////////////////////////////////////////////////////////////////////////
...
//
CDeintDMO::CDeintDMO(LPCWSTR Name, long FieldsToBuffer, long FieldsDelay, long Complexity):
    m_ComplexityIndex(Complexity),
    CVideoDMO(Name, FieldsToBuffer, FieldsDelay, IS_DEINT)

{
    ASSERT(m_NumFieldsToBuffer < MAX_FIELDS_IN_BUFFER - 1);
    m_FieldsInBuffer = 0;
    m_StartFieldsDone = 0;
    if(FieldsToBuffer > 1)
    {
...
STDMETHODIMP CDeintDMO::InternalProcessInput(DWORD dwInputStreamIndex, IMediaBuffer *pBuffer, DWORD dwFlags, REFERENCE_TIME rtTimestamp, REFERENCE_TIME rtTimelength)
{
    ...
    {
        m_IncomingFields[0].m_StartTime = rtTimestamp + rtTimelength / 2;
        m_IncomingFields[0].m_Length = rtTimelength - rtTimelength / 2;
        m_IncomingFields[1].m_StartTime = rtTimestamp;
        m_IncomingFields[1].m_Length = rtTimelength / 2;
        m_bValidTime = true;
    }
    else
    {
...
HRESULT CDeintDMO::ProcessSingleFrame(IInterlacedBufferStack* Stack, IMediaBuffer* pOutputBuffer, DWORD MidIndex)
{
    ...
    SI(IInterlacedField) pInBuffer;

    HRESULT hr = Stack->GetField(MidIndex, pInBuffer.GetReleasedInterfaceReference()); 
    ...
    // otherwise it's a 4:2:0 planar format and we just 
