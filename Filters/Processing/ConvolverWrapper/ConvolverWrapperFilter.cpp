///////////////////////////////////////////////////////////////////////////////
// $Id: ConvolverWrapperFilter.cpp,v 1.1 2005-07-21 12:42:34 adcockj Exp $
///////////////////////////////////////////////////////////////////////////////
...
BEGIN_COCLASS_TABLE(Classes)
    IMPLEMENTS_COCLASS(CConvolverWrapper)
END_COCLASS_TABLE()
...
STDAPI DllRegisterServer(void)
{
    ...
    HRESULT hr = RegisterFilter(CLSID_CConvolverWrapper, L"Convolver Wrapper", &RegInfo);
    CHECK(hr);
...
{
    HRESULT hr = UnregisterFilter(CLSID_CConvolverWrapper);
    CHECK(hr);
